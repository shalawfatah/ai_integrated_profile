...
function Projects() {
  const web_projects = projects.filter((item) => item.platform !== "mobile");
  const mobile_projects = projects.filter((item) => item.platform === "mobile");
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <Title text="Mobile Projects (React Native)" />
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
